...
public class DiceExpressionParserTests
{
    ...
    [Arguments("10%3", "MODULO(10, 3)")]
    [Arguments("10%3+1", "ADD(MODULO(10, 3), 1)")]
    [Arguments("1+10%3", "ADD(1, MODULO(10, 3))")]
    [Arguments("10%3*2", "MULTIPLY(MODULO(10, 3), 2)")]
    [Arguments("2*10%3", "MODULO(MULTIPLY(2, 10), 3)")]
